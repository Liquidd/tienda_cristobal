		...
		<table class="table table-hover shopping-cart-wrap">
			...
			<tbody>
				...
				<tr>
					<td>
						<figure class="media">
							<div class="img-wrap"><img src="<?php echo base_url()?>bootstrap_UI/images/items/2.jpg" class="img-thumbnail img-sm"></div>
							<figcaption class="media-body">
								<h6 class="title text-truncate">Product name goes here </h6>
								<dl class="dlist-inline small">
								<dt>Size: </dt>
				...
				<tr>
					<td>
						<figure class="media">
							<div class="img-wrap"><img src="<?php echo base_url()?>bootstrap_UI/images/items/3.jpg" class="img-thumbnail img-sm"></div>
							<figcaption class="media-body">
								<h6 class="title text-truncate">Product name goes here </h6>
								<dl class="dlist-inline small">
								<dt>Size: </dt>
